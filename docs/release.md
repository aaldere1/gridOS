...
Version 1.0.12 build 20 is the current production-facing direct-download version:
...
- Public release notes: `docs/release-notes/v1.0.12.md`
...
versioned as `v1.0.12`, and packaged with Sparkle automatic updates.
