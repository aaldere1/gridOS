...
Version 1.0.11 build 19 is the current production-facing direct-download version:
...
- Public release notes: `docs/release-notes/v1.0.11.md`
...
versioned as `v1.0.11`, and packaged with Sparkle automatic updates.
