...
Version 1.0.1 build 9 is the current production-facing direct-download version:
...
codesign-verified, launched from a mounted DMG, visibly versioned as `v1.0.1`,
