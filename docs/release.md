...
Version 1.0.13 build 21 is the current production-facing direct-download version:
...
- Public release notes: `docs/release-notes/v1.0.13.md`
...
versioned as `v1.0.13`, and packaged with Sparkle automatic updates.
