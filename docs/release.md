...
Version 1.0.10 build 18 is the current production-facing direct-download version:
...
- Public release notes: `docs/release-notes/v1.0.10.md`
...
versioned as `v1.0.10`, and packaged with Sparkle automatic updates.
