...
<p align="center">
  <a href="https://github.com/aaldere1/gridOS/releases/download/v1.0.8/gridOS-1.0.8-16-c60fecb.dmg"><strong>Download v1.0.8 DMG</strong></a>
  &nbsp;|&nbsp;
  <a href="https://github.com/aaldere1/gridOS/releases/tag/v1.0.8">Release</a>
  &nbsp;|&nbsp;
  <a href="docs/release-notes/v1.0.8.md">Notes</a>
  &nbsp;|&nbsp;
  <a href="docs/security-privacy.md">Security and Privacy</a>
</p>

<p align="center">
  <a href="https://github.com/aaldere1/gridOS/releases/tag/v1.0.8"><img alt="Release v1.0.8" src="https://img.shields.io/github/v/release/aaldere1/gridOS?label=release"></a>
...
| Release page | [`v1.0.8`](https://github.com/aaldere1/gridOS/releases/tag/v1.0.8) |
| DMG SHA-256 | `6884374556bb43ed2895ab9ae2a0486309d52042e069deb28b9d49e88a08e346` |

Version 1.0.8 is the terminal polish patch: reduced typing and resize jitter,
restored Command-V paste behavior in focused terminal panes, terminal-aware
Command-A and Command-C handling, and signed/notarized proof for the final
release artifact.
...
1. Download [`gridOS-1.0.8-16-c60fecb.dmg`](https://github.com/aaldere1/gridOS/releases/download/v1.0.8/gridOS-1.0.8-16-c60fecb.dmg).
2. Open the DMG.
...
Version 1.0.8 is prepared for the signed Sparkle appcast; clean-Mac install and
Sparkle update proof from 1.0.7 to 1.0.8 remain the final external validation
items.
...
The 1.0.8 release has recorded proof for the direct-download lane:
...
- Version `1.0.8` build `16` bundle check.
...
- Local 1.0.4 to 1.0.5 replacement proof, with 1.0.8 automatic updates now available for future releases.
...
- Run clean-Mac Finder/Gatekeeper UAT for the public 1.0.8 DMG.
- Prove clean-Mac Sparkle update flow from 1.0.7 to 1.0.8.
